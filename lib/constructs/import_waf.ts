...
import { listOfRules } from '../interfaces';

class ImportWaff  extends Construct {
    public associationWaf
     ...
     */
    constructor(scope: Construct, id: string, projectProps: cdk.StackProps, resources: string ) {
        super(scope, id);
     const managedRules: listOfRules[] = [{
      ...
      this.associationWaf  = new wafv2.CfnWebACLAssociation(this, 'resourceAssociation', {webAclArn: wafAclRegional.attrArn, resourceArn: resources})
